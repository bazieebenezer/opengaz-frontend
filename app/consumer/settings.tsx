...
export default function ConsumerSettings() {
  ...
  const handleResetHistory = () => {
    Alert.alert(
      ...
      "Voulez-vous vraiment supprimer tout votre historique de commandes ? Cette action est irréversible.",
      [
        { text: "Annuler", style: "cancel" },
        { 
          text: "Supprimer", 
          ...
          onPress: async () => {
            try {
              ...
              Toast.show({
                type: 'success',
                text1: 'SuccÃ¨s',
                text2: "L'historique des commandes a été réinitialisé."
              });
            } catch (error) {
              Toast.show({
                type: 'error',
                ...
                <>
                  <View className="items-center mb-12 mt-6">
                    ...
                    <View className="flex-row items-center p-3 mt-2 border border-secondary rounded-xl bg-secondary/10">
                      <User size={16} color="#ffc74a" />
                      <Text className="font-medium text-secondary ml-2 text-sm uppercase tracking-widest">Client</Text>
                    </View>
                  </View>
                ...
                <ScrollView showsVerticalScrollIndicator={false} className="max-h-[500px]">
                  <View className="mt-4">
                    ...
                    <CustomInput
                      ...
                      isValid={true}
                      isTouched={true}
                      placeholder="Votre quartier/secteur"
                      optional
                    />
                    ...
                    >
                      ...
                      <Text className="font-bold text-primary text-lg ml-2">
                        {isLocating ? "Localisation..." : editCoords ? "Position GPS enregistrée" : "Détecter ma position automatiquement"}
                      </Text>
